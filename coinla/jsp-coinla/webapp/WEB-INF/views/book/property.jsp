...
<body>
	...
	<a href="">考拉行情首页&nbsp;&nbsp;&gt;&nbsp;&nbsp;</a>
	<a href="/book">账本首页&nbsp;&nbsp;&gt;&nbsp;&nbsp;</a>
	<a href="javascript:0;" class="active">币种统计</a>
	</div>
			...
			<div class="container">
				...
				<div class="cont_left">
					<div class="stat anAlyze">
						<div class="stat_nav">
							<a class="active">币种统计</a> <a
								href="/book/location">存放场所</a>
						</div>
						<div>
...
<script src="/js/book/property.js"></script>
</html>