			...
			<div class="details_l">
				...
				<div class="details_l_con">
					<div class="details_l_con_nav">
						...
						<div class="nav_tab">
							...
							<a href="javascript:0;" class="active">币种介绍</a>
						</div>
				...
				<div class="intro child">
					...
					<div class="intro_team">
						...
						<ul class="team-single">
							<li class="avatar"><img alt=""
								src="${entity.pic}"></li>
							<li class="introduce"><p class="name">${entity.name}</p>
								<p class="cont">${entity.introduce}</p>
							</li>
						</ul>
						</c:forEach>
					</div>
