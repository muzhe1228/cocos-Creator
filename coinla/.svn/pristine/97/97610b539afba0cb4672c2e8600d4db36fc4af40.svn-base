...
+function (a) {
    ...
    b.DEFAULTS = {
        ...
        a.find(".tooltip-inner")[this.options ? "html" : "text"](b), a.removeClass("fade in top bottom left right")
    }, b.prototype.hide = function () {
        function b() {
    ...
    b.DEFAULTS = a.extend({}, a.fn.tooltip.Constructor.DEFAULTS, {
        ...
        a.find(".popover-title")[this.options ? "html" : "text"](b), a.find(".popover-content")[this.options ? "string" == typeof c ? "html" : "append" : "text"](c), a.removeClass("fade top bottom left right in"), a.find(".popover-title")() || a.find(".popover-title").hide()
    }, b.prototype.hasContent = function () {
    ...
    var j = function () {
        ...
        return c.extractDatasetName = function (b) {
            ...
            _render: function (c, d) {
                ...
                if (this.$el) {
                    var o, p = this;
                    this.$el.empty(), o = d && d.length, !o && this.templates.empty ? this.$el(e()).prepend(p.templates.header ? l() : null).append(p.templates.footer ? m() : null) : o && this.$el(f()).prepend(p.templates.header ? l() : null).append(p.templates.footer ? m() : null), this.trigger("rendered")
                }
            }, getRoot: function () {
                return this.$el
            }, update: function (a) {
