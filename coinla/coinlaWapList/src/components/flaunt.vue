      ...
      <div class="flaunt">
        <div class="flaunt_wrap">
          ...
          <div class="flaunt_text">
            ...
            <p class="text2">抽中了<span class="content">{{msg}}</span></p>
            <div class="text3">
...
<script>
  ...
  import {getContentType} from 'assets/js/httpAll'
  ...
  import html2canvas from 'html2canvas';
    export default {
      ...
      data () {
        return {
          msg: this.$route.params.getNumber
        }
      },
      metaInfo: {
        title: '炫耀一下'
      ...
      methods: {
        ...
        getImgUrl(){
          ...
          html2canvas(that.$refs.downloadApp).then(canvas => {
            ...
            this.$nextTick(() => {
              getContentType('/upload/uploadImages', fd, config).then((res) => {
                if(res.data.code == 0){
