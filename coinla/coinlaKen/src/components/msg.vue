<template>
  <div class="msg container">
    <h1 class="msg-title">考拉行情隐私声明</h1>
    <ul class="msg-wrap">
      <li>
      ...
      <li>
        ...
        <p>
        <p>(b) 本应用亦不允许任何第三方以任何手段收集、编辑、出售或者无偿传播您的个人信息。任何本应用平台用户如从事上述活动，一经发现，本应用有权立即终止与该用户的服务协议。
        <p>
        <p> (c)
