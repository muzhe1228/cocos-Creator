...
export default class TestController extends cc.Component {
    ...
    start () {
        ...
        //     self.cardGroup.showCards("123aF", null);          
        // }, this);
    }
    ...
    public testSendCards () {
        ...
        this.schedule(function (){
            var card = self.cardDealer.drawCard().getComponent(Card);
    ...
    public testWorldSpace() {
        ...
        cc.loader.loadRes("prefabs/FlyChip", cc.Prefab, function(err, prefab){
            if (err) {
                ...
                var worldPosition = self.getLatestPlayerWorldPosition();
                flyChip.setPosition(worldPosition);
            }
        });
    }

    private getLatestPlayerWorldPosition(): cc.Vec2 {
