...
export default class CardsAndResultComponent extends BaseComponent {
    ...
    // // 立即显示牛牛
    // public renderCardsNow(cards: Card[], cardValue: string, resultSprite: cc.Sprite,  result: string) {
    //     this.cardGroup.node.active = true;
    //     for (let card of cards) {
    //         this.cardGroup.obtainCard(card, true);
    //     }
    //     this.renderCards(cardValue, () => {}, true);
    //     this.renderCardResult(resultSprite, result);
    // }
}