...
export module CommonConsts {
    //线上环境
    export const imageBaseUrl = "https://img.bbpk.com/static/";
    //APP发布专用
    // export const imageBaseUrl = "http://img.bb678.info/static/";
    export const apiBaseUrl = "https://api.pk1955.com";
    export const socketBaseUrl = "wss://ws.pk1955.com/gameSocket";
    // //本地开发环境
